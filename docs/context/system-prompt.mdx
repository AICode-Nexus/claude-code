...
1. [CLAUDE.md 与上下文装载](/docs/context/claude-md-and-context-loading)

## 继续读什么

- [记忆分层](/docs/context/memory-layers)
- [Token 预算](/docs/context/token-budget)
...
- `external build active`: system prompt parts、缓存分块、上下文注入
